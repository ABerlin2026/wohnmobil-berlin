...
export const EmailChangeEmail = ({
  ...
  <Html lang="de" dir="ltr">
    <Head />
    <Preview>Bestätige die Änderung deiner E-Mail bei {siteName}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Du hast angefragt, deine E-Mail-Adresse für {siteName} von{' '}
        ...
        <Text style={text}>Klicke auf den Button, um die Änderung zu bestätigen:</Text>
        <Button style={button} href={confirmationUrl}>
          E-Mail-Änderung bestätigen
        </Button>
        <Text style={footer}>
          Falls du diese Änderung nicht angefordert hast, sichere bitte sofort
          dein Konto.
        </Text>
      </Container>
    </Body>
