  ...
  <Html lang="de" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>
          {name ? `Vielen Dank, ${name}!` : 'Vielen Dank für deine Anfrage!'}
        </Heading>
        <Text style={subtitle}>
          Wir haben deine Anfrage erhalten und melden uns schnellstmöglich bei dir
          zurück – in der Regel innerhalb von 24 Stunden. Hier findest du eine
          Kopie deiner Angaben zur Übersicht.
        </Text>
        ...
        {(costBreakdown && costBreakdown.length > 0) || totalGross ? (
          <Section style={card}>
            ...
            <Text style={hint}>
              Hinweis: Diese Aufstellung ist eine unverbindliche Vorab-Kalkulation.
              Das finale Angebot bestätigen wir dir per E-Mail.
            </Text>
          </Section>
        ) : null}
        ...
        <Section style={card}>
          <Heading as="h2" style={h2}>Deine Kontaktdaten</Heading>
        ...
        {message && (
          <Section style={card}>
            <Heading as="h2" style={h2}>Deine Nachricht</Heading>
            <Text style={messageText}>{message}</Text>
          </Section>
        )}

        <Text style={closing}>
          Falls du in der Zwischenzeit Fragen hast, antworte einfach auf diese
          E-Mail oder schreib uns per WhatsApp.
        </Text>
...
const hint = { fontSize: '12px', color: '#64748b', margin: '8px 0 0', lineHeight: '1.5', fontStyle: 'italic' as const }
const closing = { fontSize: '14px', color: '#0f172a', margin: '8px 0 0', lineHeight: '1.6' }
