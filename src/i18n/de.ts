export const de = {
  ...
  holidayHome: {
    ...
    intro: "Mal ehrlich – ein Wohnmobil als Ferienwohnung? Genau das ist der Punkt. 😉 Statt anonymem Hotelzimmer schläfst du bei uns in einem stationären Camper mitten im Grünen am Berliner Stadtrand. Ungewöhnlich, gemütlich und ein kleines Abenteuer – ideal für alle, die Lust auf etwas Außergewöhnliches haben.",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Wo erfolgt die Abholung?", a: "Die Abholung erfolgt in Berlin. Du startest deinen Roadtrip direkt aus Berlin – perfekt für eine [Tour mit dem Wohnmobil durch Brandenburg](/wohnmobil-brandenburg)." },
      { q: "Darf ich mit dem Wohnmobil ins Ausland fahren?", a: "Ja, Auslandsfahrten sind möglich – allerdings nur in bestimmte Länder, da unsere Versicherung nicht überall greift.\n\n✅ Erlaubte Länder (vom Versicherungsschutz abgedeckt):\n• Deutschland\n• Niederlande\n• Dänemark\n• Schweden\n• Norwegen\n• Finnland\n• Polen\n• Tschechien\n• Slowakei\n• Österreich\n• Schweiz\n• Ungarn\n• Slowenien\n• Kroatien\n\n❌ Nicht erlaubte Länder (kein Versicherungsschutz):\n• Belgien\n• Luxemburg\n• Frankreich\n• Italien\n• Großbritannien\n• Irland\n• Baltikum: Litauen, Lettland, Estland\n• Balkan: Serbien, Bosnien-Herzegowina, Montenegro, Nordmazedonien, Albanien\n• Rumänien\n• Bulgarien\n• Belarus\n• Ukraine\n• Moldau\n\nFahrten in nicht erlaubte Länder sind aus Versicherungsgründen leider nicht möglich." },
  ...
  contact: {
    ...
    birthdateHint: "Format: TT.MM.JJJJ – Mindestalter: 30 Jahre (Versicherungsauflage)",
    birthdateInvalid: "Bitte gib das Geburtsdatum im Format TT.MM.JJJJ ein (z. B. 15.06.1985).",
    ...
    toastNameMissing: "Name fehlt",
    toastFirstNameMissingDesc: "Bitte gib deinen Vornamen ein.",
    toastLastNameMissingDesc: "Bitte gib deinen Nachnamen ein.",
    toastNameInvalidDesc: "Bitte gib einen gültigen Namen ein (mind. 2 Zeichen, nur Buchstaben, Leerzeichen oder Bindestrich).",
    ...
    extraGrill: "Gasgrill",
    extraGrillHint: "Hinweis: 2 Gasflaschen sind ohnehin an Bord (Warmwasser, Heizung, Kochen). Der Gasverbrauch wird separat abgerechnet.",
    ...
    extraAwning: "Vorzelt (3 × 4 m)",
    extraAwningHint: "Zusätzlicher überdachter Wohnraum (3 × 4 m) bei jedem Wetter.",
