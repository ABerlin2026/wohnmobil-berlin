export const de = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Darf ich mit dem Wohnmobil ins Ausland fahren?", a: "Ja, Auslandsfahrten sind in ausgewählte Länder erlaubt. Abgedeckt sind: Deutschland, Dänemark, Schweden, Norwegen, Finnland, Polen, Tschechien, Österreich, Schweiz, Ungarn, Slowenien, Kroatien und die Slowakei. Länder wie Niederlande, Belgien, Luxemburg, Frankreich, Italien, das Baltikum (Litauen, Lettland, Estland), Großbritannien, Irland sowie der Balkan (Serbien, Bosnien, Montenegro, Nordmazedonien, Albanien), Rumänien, Bulgarien, Belarus, Ukraine und Moldau sind von unserer Versicherung nicht abgedeckt und daher leider nicht möglich." },
