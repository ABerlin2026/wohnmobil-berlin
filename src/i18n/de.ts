export const de = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Gibt es Zusatzkosten?", a: "Der Mietpreis enthält bereits die Vollkasko-Versicherung und 150 Freikilometer pro Tag. Zusätzliche Kosten können für Mehrkilometer (0,35 €/km), nicht gereinigte Rückgabe (200 €) oder optionale Extras wie den Gasgrill (40 €) oder E-Scooter (75 €) anfallen." },
      { q: "Was passiert, wenn das Fahrzeug nicht gereinigt zurückgegeben wird?", a: "Wird das Fahrzeug nicht innen und außen gereinigt zurückgegeben, fällt eine Reinigungsgebühr von 200 € an. Bei sauberer Rückgabe entstehen keine zusätzlichen Kosten. Grauwasser und Toilette müssen ebenfalls entleert werden." },
      ...
      { q: "Welche Extras kann ich hinzubuchen?", a: "Du kannst einen Gasgrill (einmalig 40 €) und einen E-Scooter (einmalig 75 €) hinzubuchen – ideal für noch mehr Flexibilität am Stellplatz." },
      { q: "Ist Bettwäsche enthalten?", a: "Nein, Bettwäsche ist nicht im Mietpreis enthalten. Bitte bring eigene Bettwäsche oder Schlafsäcke mit." },
