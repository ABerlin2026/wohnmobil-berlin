...
export const en: typeof de = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Can I drive the motorhome abroad?", a: "Yes, trips abroad are possible in selected countries. Covered are: Germany, the Netherlands, Denmark, Sweden, Norway, Finland, Poland, Czech Republic, Austria, Switzerland, Hungary, Slovenia, Croatia and Slovakia. Countries such as Belgium, Luxembourg, France, Italy, the Baltic states (Lithuania, Latvia, Estonia), the United Kingdom, Ireland as well as the Balkans (Serbia, Bosnia, Montenegro, North Macedonia, Albania), Romania, Bulgaria, Belarus, Ukraine and Moldova are not covered by our insurance and are therefore unfortunately not permitted." },
  ...
  contact: {
    ...
    birthdateHint: "Minimum age: 30 years (insurance requirement)",
