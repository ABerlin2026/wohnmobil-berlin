...
const groups = [
  ...
  { icon: MapPin, title: "Für Roadtrips ab Berlin", text: "{ icon: MapPin, title: "Für Roadtrips ab Berlin", text: "Direkt aus Berlin – Ostsee, Sächsische Schweiz oder Brandenburg." }, – Ostsee, Sächsische Schweiz oder Brandenburg." },
