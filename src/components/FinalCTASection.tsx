    ...
    <section className="section-padding bg-primary text-primary-foreground">
      <div className="container-narrow text-center max-w-3xl">
        ...
        <p className="text-lg opacity-90 leading-relaxed mb-3">
          Wohnmobil mieten, losfahren, frei sein – so einfach kann Urlaub sein. Unser Camper wartet in Berlin Buchholz auf dich.
        </p>
        <p className="text-sm opacity-70 mb-8">
          Gerade in der Hauptsaison sind beliebte Zeiträume schnell vergeben. Sichere dir jetzt deinen Wunschtermin.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button variant="hero-outline" size="lg" onClick={scrollToContact} className="py-5 px-8">
